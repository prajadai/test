...
export default function Dashboard() {
  const [quote, setQuote] = useState("Those who cannot tame the art of Version Control, are but rudderless ships adrift in the boundless sea of code.");
      ...
      <Box pt={{ base: "60px", md: "80px", xl: "10px" }}>
        ...
        <Flex direction="column" justifyContent="center" alignItems="center">
          ...
          >
            Random Quote
            <Box
              fontSize={{ sm: "1.5em", md: "1.7em", xl: "1.9em" }}
